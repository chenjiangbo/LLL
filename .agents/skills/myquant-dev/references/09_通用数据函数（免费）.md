...
> **来源**: https://www.myquant.cn/docs2/sdk/python/API介绍/通用数据函数（免费）.html
> **标题**: 通用数据函数（免费） - 掘金量化
...
**函数原型：**
    ...
    get_symbol_infos(sec_type1, sec_type2=None, exchanges=None, symbols=None, df=False)**参数：**
...
**函数原型：**
    ...
    get_symbols(sec_type1, sec_type2=None, exchanges=None, symbols=None, skip_suspended=True, skip_st=True, trade_date=None, df=False)**参数：**
...
**函数原型：**
    ...
    get_history_symbol(symbol=None, start_date=None, end_date=None, df=False)**参数：**
