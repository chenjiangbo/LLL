...
**示例：**
    ...
    get_open_call_auction(symbols='SHSE.113689, SZSE.123100', trade_date='2025-03-27')**输出：**
    ...
    1     500  122.58100128  122.57399750   122.5  122.46499634  122.34999847**注意：**
...
← [ 基金增值数据函数（付费） ](/docs2/sdk/python/API介绍/基金增值数据函数（付费）.html) [ 交易函数 ](/docs2/sdk/python/API介绍/交易函数.html) → 
